...
OUT_DIR = Path(f"./case_study_for_mdm2_1ycr_head_to_tail_design/design_results_{f_name}_contact_loss_{MAX_ITERATIONS}_higher_temp_T_0.5")
...
SEED = 42 #12  # Random seed for reproducibility
PROTMPNN_SEED = 17  # Seed for ProteinMPNN
PROTMPNN_SAMPLING_TEMP = 0.1 #0.5  # Sampling temperature for ProteinMPNN
all_chain_ids = []
