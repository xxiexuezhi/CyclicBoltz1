...
OUT_DIR = Path(f"./add_interface_residue_total_score4__all_results_on_higher_temp_T_0.5/design_results_{f_name}_contact_loss_{MAX_ITERATIONS}_higher_temp_T_0.5")
...
PROTMPNN_SEED = 37  # Seed for ProteinMPNN
