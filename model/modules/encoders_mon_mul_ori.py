...
class RelativePositionEncoder_multimer(Module):
...
class RelativePositionEncoder_monomer(Module):
    """Relative position encoder with cyclic offset support."""
...
#         # the below is modified for cyclic offset.
        ...
        d_residue = self.cyclic_offset(L) + self.r_max #(len(feats["residue_index"]))
...
class RelativePositionEncoder_original(Module):
